...
protected:
    ...
    /// @brief 指针解引用指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_load_ptr(Instruction * inst);

    /// @brief 指针存储指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_store_ptr(Instruction * inst);

    /// @brief 指针加法指令翻译成ARM32汇编
    /// @param inst IR指令
    void translate_add_ptr(Instruction * inst);

    /// @brief 数组元素地址计算指令翻译成ARM32汇编
    /// @param inst IR指令
