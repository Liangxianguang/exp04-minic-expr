...
public:
  enum {
    ...
    COMMENT = 18, BLOCK_COMMENT = 19, WS = 20
  };
  ...
  enum {
    ...
    RuleAddExp = 12, RuleAddOp = 13, RuleMulDivExp = 14, RuleMulDivOp = 15, 
    RuleUnaryExp = 16, RulePrimaryExp = 17, RuleRealParamList = 18, RuleLVal = 19
  };
